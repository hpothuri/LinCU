...
public class LinCuAMImpl extends ApplicationModuleImpl implements LinCuAM {
    ...
    row.createCell(0).setCellValue(dataRow.getAttributeHints("CardId").getLabel(null)); //setting column heading
    sheet.autoSizeColumn(0);
    row.getCell(0).setCellStyle(colStyleTopLeft);
    row.createCell(1).setCellValue(dataRow.getAttributeHints("CardReqType").getLabel(null));
    sheet.autoSizeColumn(1);
    row.getCell(1).setCellStyle(colStyleTopLeft);
    row.createCell(2).setCellValue(dataRow.getAttributeHints("CardStatus").getLabel(null));
    sheet.autoSizeColumn(2);
    row.getCell(2).setCellStyle(colStyleTopLeft);
    row.createCell(3).setCellValue(dataRow.getAttributeHints("CreditUnionId").getLabel(null));
    sheet.autoSizeColumn(3);
    row.getCell(3).setCellStyle(colStyleTopLeft);
    row.createCell(4).setCellValue(dataRow.getAttributeHints("MemberId").getLabel(null));
    sheet.autoSizeColumn(4);
    row.getCell(4).setCellStyle(colStyleTopLeft);
    row.createCell(5).setCellValue(dataRow.getAttributeHints("CreatedBy").getLabel(null));
    sheet.autoSizeColumn(5);
    row.getCell(5).setCellStyle(colStyleTopLeft);
    row.createCell(6).setCellValue(dataRow.getAttributeHints("CreatedOn").getLabel(null));
    sheet.autoSizeColumn(6);
    row.getCell(6).setCellStyle(colStyleTopLeft);
    row.createCell(7).setCellValue(dataRow.getAttributeHints("SubmittedOn").getLabel(null));
    sheet.autoSizeColumn(7);
    row.getCell(7).setCellStyle(colStyleTopLeft);
    row.createCell(8).setCellValue(dataRow.getAttributeHints("MemberPrefix").getLabel(null));
    sheet.autoSizeColumn(8);
    row.getCell(8).setCellStyle(colStyleTopLeft);
    row.createCell(9).setCellValue(dataRow.getAttributeHints("FirstName").getLabel(null));
    sheet.autoSizeColumn(9);
    row.getCell(9).setCellStyle(colStyleTopLeft);        
    row.createCell(10).setCellValue(dataRow.getAttributeHints("MiddleName").getLabel(null));
    sheet.autoSizeColumn(10);
    row.getCell(10).setCellStyle(colStyleTopLeft); 
    row.createCell(11).setCellValue(dataRow.getAttributeHints("LastName").getLabel(null));
    sheet.autoSizeColumn(11);
    row.getCell(11).setCellStyle(colStyleTopLeft); 
    row.createCell(12).setCellValue(dataRow.getAttributeHints("MotherMaidenName").getLabel(null));
    sheet.autoSizeColumn(12);
    row.getCell(12).setCellStyle(colStyleTopLeft); 
    row.createCell(13).setCellValue(dataRow.getAttributeHints("DateOfBirth").getLabel(null));
    sheet.autoSizeColumn(13);
    row.getCell(13).setCellStyle(colStyleTopLeft); 
    row.createCell(14).setCellValue(dataRow.getAttributeHints("Email").getLabel(null));
    sheet.autoSizeColumn(14);
    row.getCell(14).setCellStyle(colStyleTopLeft);
        row.createCell(15).setCellValue(dataRow.getAttributeHints("Gender").getLabel(null));
        sheet.autoSizeColumn(15);
        row.getCell(15).setCellStyle(colStyleTopLeft);
        row.createCell(16).setCellValue(dataRow.getAttributeHints("MaritalStatus").getLabel(null));
        sheet.autoSizeColumn(16);
        row.getCell(16).setCellStyle(colStyleTopLeft);        
        row.createCell(17).setCellValue(dataRow.getAttributeHints("NoOfDependents").getLabel(null));
        sheet.autoSizeColumn(17);
        row.getCell(17).setCellStyle(colStyleTopLeft); 
        row.createCell(18).setCellValue(dataRow.getAttributeHints("ElectorialId").getLabel(null));
        sheet.autoSizeColumn(18);
        row.getCell(18).setCellStyle(colStyleTopLeft); 
        row.createCell(19).setCellValue(dataRow.getAttributeHints("PassportNo").getLabel(null));
        sheet.autoSizeColumn(19);
        row.getCell(19).setCellStyle(colStyleTopLeft); 
        row.createCell(20).setCellValue(dataRow.getAttributeHints("DriverPermit").getLabel(null));
        sheet.autoSizeColumn(20);
        row.getCell(20).setCellStyle(colStyleTopLeft); 
        row.createCell(21).setCellValue(dataRow.getAttributeHints("BirNo").getLabel(null));
        sheet.autoSizeColumn(21);
        row.getCell(21).setCellStyle(colStyleTopLeft);
        row.createCell(22).setCellValue(dataRow.getAttributeHints("HomePhoneNumber").getLabel(null));
        sheet.autoSizeColumn(22);
        row.getCell(22).setCellStyle(colStyleTopLeft);
        row.createCell(23).setCellValue(dataRow.getAttributeHints("MobilePhoneNumber").getLabel(null));
        sheet.autoSizeColumn(23);
        row.getCell(23).setCellStyle(colStyleTopLeft);
        row.createCell(24).setCellValue(dataRow.getAttributeHints("FaxNumber").getLabel(null));
        sheet.autoSizeColumn(24);
        row.getCell(24).setCellStyle(colStyleTopLeft);
        row.createCell(25).setCellValue(dataRow.getAttributeHints("EducationCode").getLabel(null));
        sheet.autoSizeColumn(25);
        row.getCell(25).setCellStyle(colStyleTopLeft);
        row.createCell(26).setCellValue(dataRow.getAttributeHints("MonthlySalary").getLabel(null));
        sheet.autoSizeColumn(26);
        row.getCell(26).setCellStyle(colStyleTopLeft);
        row.createCell(27).setCellValue(dataRow.getAttributeHints("ShareholderCode").getLabel(null));
        sheet.autoSizeColumn(27);
        row.getCell(27).setCellStyle(colStyleTopLeft);
        row.createCell(28).setCellValue(dataRow.getAttributeHints("PermanentAddrLine1").getLabel(null));
        sheet.autoSizeColumn(28);
        row.getCell(28).setCellStyle(colStyleTopLeft);
        row.createCell(29).setCellValue(dataRow.getAttributeHints("PermanentAddrLine2").getLabel(null));
        sheet.autoSizeColumn(29);
        row.getCell(29).setCellStyle(colStyleTopLeft);
        row.createCell(30).setCellValue(dataRow.getAttributeHints("PermanentAddrLine3").getLabel(null));
        sheet.autoSizeColumn(30);
        row.getCell(30).setCellStyle(colStyleTopLeft);
        row.createCell(31).setCellValue(dataRow.getAttributeHints("PermanentAddrLine4").getLabel(null));
        sheet.autoSizeColumn(31);
        row.getCell(31).setCellStyle(colStyleTopLeft);
        row.createCell(32).setCellValue(dataRow.getAttributeHints("PermanentCity").getLabel(null));
        sheet.autoSizeColumn(32);
        row.getCell(32).setCellStyle(colStyleTopLeft);
        row.createCell(33).setCellValue(dataRow.getAttributeHints("PermanentState").getLabel(null));
        sheet.autoSizeColumn(33);
        row.getCell(33).setCellStyle(colStyleTopLeft);
        row.createCell(34).setCellValue(dataRow.getAttributeHints("PermanentCountryCode").getLabel(null));
        sheet.autoSizeColumn(34);
        row.getCell(34).setCellStyle(colStyleTopLeft);
        row.createCell(35).setCellValue(dataRow.getAttributeHints("PermanentZipCode").getLabel(null));
        sheet.autoSizeColumn(35);
        row.getCell(35).setCellStyle(colStyleTopLeft);
        row.createCell(36).setCellValue(dataRow.getAttributeHints("HomeOwnership").getLabel(null));
        sheet.autoSizeColumn(36);
        row.getCell(36).setCellStyle(colStyleTopLeft);
        row.createCell(37).setCellValue(dataRow.getAttributeHints("MailingAddrLine1").getLabel(null));
        sheet.autoSizeColumn(37);
        row.getCell(37).setCellStyle(colStyleTopLeft);
        row.createCell(38).setCellValue(dataRow.getAttributeHints("MailingAddrLine2").getLabel(null));
        sheet.autoSizeColumn(38);
        row.getCell(38).setCellStyle(colStyleTopLeft);
        row.createCell(39).setCellValue(dataRow.getAttributeHints("MailingAddrLine3").getLabel(null));
        sheet.autoSizeColumn(39);
        row.getCell(39).setCellStyle(colStyleTopLeft);
        row.createCell(40).setCellValue(dataRow.getAttributeHints("MailingAddrLine4").getLabel(null));
        sheet.autoSizeColumn(40);
        row.getCell(40).setCellStyle(colStyleTopLeft);
        row.createCell(41).setCellValue(dataRow.getAttributeHints("MailingCity").getLabel(null));
        sheet.autoSizeColumn(41);
        row.getCell(41).setCellStyle(colStyleTopLeft);
        row.createCell(42).setCellValue(dataRow.getAttributeHints("MailingState").getLabel(null));
        sheet.autoSizeColumn(42);
        row.getCell(42).setCellStyle(colStyleTopLeft);
        row.createCell(43).setCellValue(dataRow.getAttributeHints("MailingCountryCode").getLabel(null));
        sheet.autoSizeColumn(43);
        row.getCell(43).setCellStyle(colStyleTopLeft);
        row.createCell(44).setCellValue(dataRow.getAttributeHints("MailingZipCode").getLabel(null));
        sheet.autoSizeColumn(44);
        row.getCell(44).setCellStyle(colStyleTopLeft);
        row.createCell(45).setCellValue(dataRow.getAttributeHints("Employer").getLabel(null));
        sheet.autoSizeColumn(45);
        row.getCell(45).setCellStyle(colStyleTopLeft);
        row.createCell(46).setCellValue(dataRow.getAttributeHints("EmployerAddress1").getLabel(null));
        sheet.autoSizeColumn(46);
        row.getCell(46).setCellStyle(colStyleTopLeft);
        row.createCell(47).setCellValue(dataRow.getAttributeHints("EmployerAddress2").getLabel(null));
        sheet.autoSizeColumn(47);
        row.getCell(47).setCellStyle(colStyleTopLeft);
        row.createCell(48).setCellValue(dataRow.getAttributeHints("BusinessPhoneExtn").getLabel(null));
        sheet.autoSizeColumn(48);
        row.getCell(48).setCellStyle(colStyleTopLeft);
        row.createCell(49).setCellValue(dataRow.getAttributeHints("BusinessPhoneNumber").getLabel(null));
        sheet.autoSizeColumn(49);
        row.getCell(49).setCellStyle(colStyleTopLeft);
        row.createCell(50).setCellValue(dataRow.getAttributeHints("OccupationCode").getLabel(null));
        sheet.autoSizeColumn(50);
        row.getCell(50).setCellStyle(colStyleTopLeft);
        row.createCell(51).setCellValue(dataRow.getAttributeHints("EmployerCity").getLabel(null));
        sheet.autoSizeColumn(51);
        row.getCell(51).setCellStyle(colStyleTopLeft);
        row.createCell(52).setCellValue(dataRow.getAttributeHints("BirthCountryCode").getLabel(null));
        sheet.autoSizeColumn(52);
        row.getCell(52).setCellStyle(colStyleTopLeft);
        row.createCell(53).setCellValue(dataRow.getAttributeHints("CitizenShipCountry1").getLabel(null));
        sheet.autoSizeColumn(53);
        row.getCell(53).setCellStyle(colStyleTopLeft);
        row.createCell(54).setCellValue(dataRow.getAttributeHints("CitizenShipCountry2").getLabel(null));
        sheet.autoSizeColumn(54);
        row.getCell(54).setCellStyle(colStyleTopLeft);
        row.createCell(55).setCellValue(dataRow.getAttributeHints("CitizenShipCountry3").getLabel(null));
        sheet.autoSizeColumn(55);
        row.getCell(55).setCellStyle(colStyleTopLeft);
        row.createCell(56).setCellValue(dataRow.getAttributeHints("CitizenShipCountry4").getLabel(null));
        sheet.autoSizeColumn(56);
        row.getCell(56).setCellStyle(colStyleTopLeft);
        row.createCell(57).setCellValue(dataRow.getAttributeHints("LocalTaxExempt").getLabel(null));
        sheet.autoSizeColumn(57);
        row.getCell(57).setCellStyle(colStyleTopLeft);
        row.createCell(58).setCellValue(dataRow.getAttributeHints("Nationality").getLabel(null));
        sheet.autoSizeColumn(58);
        row.getCell(58).setCellStyle(colStyleTopLeft);
        row.createCell(59).setCellValue(dataRow.getAttributeHints("EligibleForeignTax").getLabel(null));
        sheet.autoSizeColumn(59);
        row.getCell(59).setCellStyle(colStyleTopLeft);
        row.createCell(60).setCellValue(dataRow.getAttributeHints("DocForeignTaxExempt").getLabel(null));
        sheet.autoSizeColumn(60);
        row.getCell(60).setCellStyle(colStyleTopLeft);
        row.createCell(61).setCellValue(dataRow.getAttributeHints("ForeignCitizenship").getLabel(null));
        sheet.autoSizeColumn(61);
        row.getCell(61).setCellStyle(colStyleTopLeft);
        row.createCell(62).setCellValue(dataRow.getAttributeHints("PowerOfAttorney").getLabel(null));
    ...
    sheet.autoSizeColumn(2);
    row.createCell(3).setCellValue(dataRow.getCreditUnionId());
    sheet.autoSizeColumn(3);
